...
//   setAgentStatus("Listening for your order...");

//   appendMessage("🤖 Welcome to Banana Leaf Restaurant 🍃");
//   appendMessage("🤖 Please tell your name.");
...
// Please say CONFIRM to place order`
//     );
